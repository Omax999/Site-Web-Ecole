<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="PageProf.aspx.cs" Inherits="Ecoule.PageProf" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content" class="content">
            <div class="content_Seance">
                <table class="tbl_ValideSeance">
                    ...
                    <tr>
                        ...
                        <td class="left"><asp:DropDownList ID="cmbHeureDebut" runat="server" AutoPostBack="true"  Width="100%">
                            <asp:ListItem>8:30</asp:ListItem>
                                         </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td class="left"><label for="cmbHeureFin">Heure Fin</label></td>
                        <td class="left"><asp:DropDownList ID="cmbHeureFin" runat="server" AutoPostBack="true" Width="100%">
                ...
                <asp:GridView ID="ListSeance" runat="server" CellPadding="4" GridLines="None" AllowSorting="True" AutoGenerateColumns="False" ForeColor="#333333" DataSourceID="SeanceData">
                    ...
                    <Columns>
                        <asp:BoundField DataField="Module" HeaderText="Module" SortExpression="Module" ApplyFormatInEditMode="true"/>
                ...
                <asp:SqlDataSource ID="GroupData" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT [ID_GROUP] FROM [DETAIL_SEANCE] WHERE ([PROFESSEUR] = @PROFESSEUR)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="lblNumero" Name="PROFESSEUR" PropertyName="Text" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <asp:SqlDataSource ID="ModuleData" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT [ID_MODULE] FROM [DETAIL_SEANCE] WHERE (([ID_GROUP] = @ID_GROUP) AND ([PROFESSEUR] = @PROFESSEUR))">
                    <SelectParameters>
            ...
            <div class="content_participer_seance">
                <h3>Participation</h3>
                <asp:Label ID="lblGroupParticiper" CssClass="lbl_choix" runat="server">Group</asp:Label><asp:DropDownList ID="cmbGroupSeance" runat="server" CssClass="cmb_choix" Width="10%" AutoPostBack="True" DataSourceID="GroupData" DataTextField="ID_GROUP" DataValueField="ID_GROUP" OnSelectedIndexChanged="cmbGroupSeance_SelectedIndexChanged"></asp:DropDownList>
                ...
                <div id="content_participer_seance" runat="server">
                    <asp:ImageButton ID="btnRefecheListParticipation" ToolTip="Refresh" Visible="false" CssClass="btn_refreche" runat="server" ImageUrl="~/icons/icons8-refresh-32.png" Width="20px"/>
                    <asp:ImageButton ID="btnTelechargerPdf" runat="server" Visible="false" OnClick="btnTelechargerPdf_Click" CssClass="btn_pdf" ToolTip="Telecharger Sous Format PDF" ImageUrl="~/icons/icons8-download-24.png" Width="22px" />
                    <asp:GridView ID="ListParticipation" runat="server" CssClass="list_view" Width="70%"
                        AutoGenerateColumns="False" OnSelectedIndexChanged="ListParticipation_SelectedIndexChanged"
                    ...
                    <asp:Label ID="lblnumEtdParticiper" runat="server" CssClass="lbl_choixP" Text="Numero" Visible="False"></asp:Label><asp:TextBox ID="NumEtdParticiper" runat="server" Enabled="false" Visible="False"></asp:TextBox>
                    <asp:Label ID="lblnumSeance" runat="server" CssClass="lbl_choixP" Text="Numero Seance" Visible="False"></asp:Label><asp:TextBox ID="NumSeanceParticiper" runat="server" Enabled="false" Visible="False"></asp:TextBox>
                    <asp:CheckBox ID="Present" runat="server" CssClass="lbl_choixP" Text="Present" TextAlign="Left" Visible="False" />
                    <br />
            ...
            <div class="content_exame">
                <div classe="Content_Note">
                    <asp:Label ID="lblGroup2" CssClass="lbl_choix" runat="server">Group</asp:Label><asp:DropDownList ID="cmbExameGroup" runat="server" CssClass="cmb_choix" Width="10%" DataSourceID="GroupData" DataTextField="ID_GROUP" AutoPostBack="true" OnSelectedIndexChanged="cmbExameGroup_SelectedIndexChanged" DataValueField="ID_GROUP"></asp:DropDownList>
                    <asp:Label ID="lblExame" CssClass="lbl_choix" runat="server">Exame</asp:Label><asp:DropDownList ID="cmbExame" runat="server" CssClass="cmb_choix" Width="10%" DataSourceID="ExameData" DataTextField="ID_EXAME" AutoPostBack="true" OnSelectedIndexChanged="cmbExamen_SelectedIndexChanged" DataValueField="ID_EXAME"></asp:DropDownList>
                    <asp:GridView ID="ListNotesExame" runat="server" CssClass="list_view" Width="70%" AutoGenerateColumns="False" CellPadding="4" GridLines="None" ForeColor="#333333" AutoGenerateSelectButton="True" DataKeyNames="NUMERO_ETUDIANT" DataSourceID="ListNotesExameData">
                        <Columns>
